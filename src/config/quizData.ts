  ...
  'cloud-architecture': {
    ...
    questions: [
      ...
      // ---- EASY (additional) ----
      {
        id: 'ca-e4',
        difficulty: 'easy',
        question: 'Who created the Twelve-Factor App methodology?',
        choices: [
          'Jeff Bezos',
        ...
        correctIndex: 1,
        explanation: 'Adam Wiggins, co-founder of Heroku, created the Twelve-Factor App methodology as foundational principles for cloud-native apps.',
      },
      {
        id: 'ca-e5',
        difficulty: 'easy',
        question: 'Which of these is NOT mentioned as a cloud-native technology by the CNCF?',
        choices: ['Containers', 'Service meshes', 'Mainframe batch processing', 'Microservices'],
        correctIndex: 2,
        explanation: 'The CNCF lists containers, service meshes, microservices, immutable infrastructure, and declarative APIs. Mainframe batch processing is not cloud-native.',
      },
      {
        id: 'ca-e6',
        difficulty: 'easy',
        question: 'What does "declarative APIs" mean in a cloud-native context?',
        choices: [
          'APIs that declare their input types explicitly',
          'APIs where you describe the desired state and the system figures out how to achieve it',
          'APIs with auto-generated Swagger documentation',
          'APIs that only accept GET requests',
        ],
        correctIndex: 1,
        explanation: 'Declarative APIs let you state what you want (desired state), not how to get there \u2014 as with Kubernetes manifests or Terraform configs.',
      },
      {
        id: 'ca-e7',
        difficulty: 'easy',
        question: 'Which cloud-native pattern isolates a failing service to prevent it from exhausting shared resources and taking down others?',
        choices: ['Circuit breaker', 'Retry with backoff', 'Bulkhead', 'Graceful degradation'],
        correctIndex: 2,
        explanation: 'The Bulkhead pattern partitions resources so that a failure in one area cannot consume all shared capacity and cascade to unrelated services.',
      },
      {
        id: 'ca-e8',
        difficulty: 'easy',
        question: 'What is "graceful degradation" in a cloud-native system?',
        choices: [
          'Gradually reducing server capacity to save costs',
          'The system continues to provide partial functionality even when some components fail',
          'A planned maintenance window with reduced service',
          'Slowly deprecating old APIs over time',
        ],
        correctIndex: 1,
        explanation: 'Graceful degradation means the system remains partially available when components fail, rather than going completely down.',
      },
      {
        id: 'ca-e9',
        difficulty: 'easy',
        question: 'What is the Twelve-Factor App\'s stance on application processes?',
        choices: [
          'Processes should be stateful and long-running',
          'Processes should be stateless and share nothing',
          'Processes should write all data to local disk',
          'Processes should run as root for simplicity',
        ],
        correctIndex: 1,
        explanation: 'Factor 6 says "execute as stateless processes" \u2014 no sticky sessions, no local state. This enables horizontal scaling and fast replacement.',
      },
      {
        id: 'ca-e10',
        difficulty: 'easy',
        question: 'What does "elasticity" mean in cloud-native architecture?',
        choices: [
          'The system is flexible in its code design',
          'The system can scale resources up or down on demand based on load',
          'The system automatically recovers from failures',
          'The system uses Elasticsearch for all data storage',
        ],
        correctIndex: 1,
        explanation: 'Elasticity means matching resource capacity to demand \u2014 scaling out under load and releasing resources when demand drops.',
      },
      // ---- MEDIUM (additional) ----
      {
        id: 'ca-m4',
        difficulty: 'medium',
        question: 'A microservice fails to respond. Rather than letting callers queue up indefinitely, what should happen?',
        choices: [
          'The service should restart immediately and automatically',
          'Callers should wait until the natural TCP timeout',
          'The circuit breaker trips and requests fail fast, giving the service time to recover',
          'The load balancer increases the thread pool',
        ],
        correctIndex: 2,
        explanation: 'An open circuit breaker fails requests immediately rather than accumulating waiting threads \u2014 preventing resource exhaustion while the downstream recovers.',
      },
      {
        id: 'ca-m5',
        difficulty: 'medium',
        question: 'Twelve-Factor factor 6 says "execute as stateless processes." What does this specifically enable?',
        choices: [
          'Data persistence across restarts without a database',
          'Easy horizontal scaling \u2014 any instance can handle any request because no local state is required',
          'Better performance through in-process caching',
          'Simpler authentication logic',
        ],
        correctIndex: 1,
        explanation: 'Stateless processes are interchangeable: spin up more to handle load, kill any one without data loss. This is the foundation of horizontal scalability.',
      },
      {
        id: 'ca-m6',
        difficulty: 'medium',
        question: 'Twelve-Factor factor 4 says "treat backing services as attached resources." What does this mean in practice?',
        choices: [
          'Back up all services with redundant copies',
          'A database, queue, or email service is interchangeable \u2014 swap it without any code changes',
          'Services need redundant backup hardware',
          'Backing services provide disaster recovery capabilities',
        ],
        correctIndex: 1,
        explanation: 'An attached resource is swappable via configuration. The app treats a local MySQL and a cloud RDS identically \u2014 the URL in config is the only difference.',
      },
      {
        id: 'ca-m7',
        difficulty: 'medium',
        question: 'What is the purpose of "retry with backoff" in cloud-native architecture?',
        choices: [
          'Retry a failed request with increasing delays, giving the failing service time to recover',
          'Back up data before retrying any operation',
          'Exponentially increase server capacity when failures occur',
          'Log all failed requests for later batch reprocessing',
        ],
        correctIndex: 0,
        explanation: 'Retry with backoff avoids hammering an already-struggling service: each retry waits longer, reducing pressure while giving the target time to recover.',
      },
      {
        id: 'ca-m8',
        difficulty: 'medium',
        question: 'Twelve-Factor factor 9 (Disposability) says to maximize robustness with fast startup. Why does this matter?',
        choices: [
          'Faster startup means lower cloud bills per second',
          'Fast startup enables rapid scaling and recovery \u2014 instances can be replaced quickly without prolonged outages',
          'It improves developer experience during local development',
          'It reduces the complexity of the application code',
        ],
        correctIndex: 1,
        explanation: 'Disposable processes with fast startup enable elasticity and self-healing: the orchestrator can replace a failed instance quickly, minimising MTTR.',
      },
      {
        id: 'ca-m9',
        difficulty: 'medium',
        question: 'What does Twelve-Factor factor 10 (Dev/prod parity) prevent?',
        choices: [
          'Slow deployments due to environment setup time',
          'The "works on my machine" problem \u2014 differences between environments causing production-only bugs',
          'Security vulnerabilities in development',
          'High cloud costs in the production environment',
        ],
        correctIndex: 1,
        explanation: 'Dev/prod parity means the gap between development and production is as small as possible \u2014 eliminating the class of bugs that only appear in one environment.',
      },
      {
        id: 'ca-m10',
        difficulty: 'medium',
        question: 'Twelve-Factor factor 11 says "treat logs as event streams." What does this mean in practice?',
        choices: [
          'Store logs in a relational database for querying',
          'The application writes to stdout; log routing and aggregation is handled by the platform infrastructure',
          'Logs must be in JSON format at all times',
          'Applications are responsible for managing their own log rotation',
        ],
        correctIndex: 1,
        explanation: 'Apps just write to stdout; the execution environment routes those streams to log aggregators. Apps have no opinion on where logs end up.',
      },
      // ---- HARD (additional) ----
      {
        id: 'ca-h4',
        difficulty: 'hard',
        question: 'Which of the twelve factors specifically mandates separating build, release, and run stages?',
        choices: [
          'Factor 1 (Codebase)',
          'Factor 3 (Config)',
        ...
        correctIndex: 2,
        explanation: 'Factor 5 prohibits changes to code at runtime. Build creates the artifact; release combines it with config; run starts the process. The stages are strictly separated.',
      },
      {
        id: 'ca-h5',
        difficulty: 'hard',
        question: 'The "cattle not pets" philosophy enables immutable infrastructure. What does "immutable" mean here?',
        choices: [
          'Servers are guaranteed never to fail',
          'Updates mean replacing instances with new ones rather than patching them in place',
          'Infrastructure code is read-only after the first deployment',
          'The same binary runs on every server in the fleet',
        ],
        correctIndex: 1,
        explanation: 'Immutable infrastructure: never mutate a running server. Deploy a change by replacing the instance with a new one built from the updated image.',
      },
      {
        id: 'ca-h6',
        difficulty: 'hard',
        question: 'Which Twelve-Factor factor establishes that one codebase in version control maps to many deploys?',
        choices: [
          'Factor 1 (Codebase)',
        ...
        correctIndex: 0,
        explanation: 'Factor 1 says one codebase per app, tracked in VCS, deployed to multiple environments (staging, production, etc.) from the same repo.',
      },
      {
        id: 'ca-h7',
        difficulty: 'hard',
        question: 'A circuit breaker "opens" after a downstream service fails repeatedly. What happens next, according to the deep dive?',
        choices: [
          'All traffic to the downstream service is dropped permanently',
          'Requests fail fast immediately (no timeout wait), and the circuit resets after a recovery period',
          'The failing service is automatically restarted',
          'The circuit breaker increases retry attempts',
        ],
        correctIndex: 1,
        explanation: 'An open circuit fails requests immediately, avoiding timeout waits. After a timeout period the circuit enters "half-open" state to test whether the downstream has recovered.',
      },
      {
        id: 'ca-h8',
        difficulty: 'hard',
        question: 'Twelve-Factor factor 8 says "scale out via the process model." What does this contrast with?',
        choices: [
          'Vertical scaling \u2014 adding more CPU or RAM to a single server',
          'Horizontal auto-scaling managed by a container orchestrator',
          'Microservices decomposition',
          'Container-based deployment',
        ],
        correctIndex: 0,
        explanation: 'Scale-out (horizontal) means running more instances of a stateless process. This contrasts with scale-up (vertical) which adds resources to one machine and hits hard limits.',
      },
      {
        id: 'ca-h9',
        difficulty: 'hard',
        question: 'The deep dive credits which book with popularising the circuit breaker pattern for software?',
        choices: [
          '"The Phoenix Project" by Gene Kim',
        ...
        correctIndex: 1,
        explanation: '"Release It!" by Michael Nygard introduced and popularised the circuit breaker and bulkhead patterns for building resilient production software.',
      },
      {
        id: 'ca-h10',
        difficulty: 'hard',
        question: 'Twelve-Factor factor 2 says "explicitly declare and isolate dependencies." Which tool best embodies this in modern applications?',
        choices: [
          'Git tags for versioning releases',
          'Package managers with lock files (npm, pip, Maven, etc.) that pin exact dependency versions',
          'Environment variables for dependency locations',
          'Makefiles for build automation',
        ],
        correctIndex: 1,
        explanation: 'Lock files (package-lock.json, Pipfile.lock, etc.) ensure reproducible builds by pinning exact dependency versions \u2014 no implicit reliance on system-installed libraries.',
      },
    ],
  },
};
